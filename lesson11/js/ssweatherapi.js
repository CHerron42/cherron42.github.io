const apiURL = 'https://api.openweathermap.org/data/2.5/weather?id=5678757&units=imperial&appid=00345bb8bc2f7487208d75072ff68c67';
fetch(apiURL)
...
const URL = 'https://api.openweathermap.org/data/2.5/forecast?id=5678757&units=imperial&appid=00345bb8bc2f7487208d75072ff68c67';
fetch(URL)
  .then((response) => response.json())
  .then((res) => {
